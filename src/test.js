                    ...
                    switch (act) {
                        ...
                        if(cell_validate == true){ //valid 10 digit number
                            ...
                            sendOtp.send("91"+mobile_no, "DrBuny", otp, function (error, data, res) {  
                                ...
                                if(data.type == 'success'){ // wrong mobile number

                                     //sending back response to user           
                                        let alert_2 = "OTP send successfully";                  
                                            
                                        this.sendFBMessage(sender, {text: alert_2})
                                        .then(mm => {
                                     ...
                                     //sending back response to user    
                                    let alert_3 = "OTP sent successfully";                  
                                    
                                    this.sendFBMessage(sender, {text1: alert_3})
                                    .then(mmm => {
                             ...
                             //sending back response to user           
                                ...
                                this.sendFBMessage(sender, {text: alert_1})
                                .then(m => {
